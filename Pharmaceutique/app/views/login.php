    ...
    <
      <div class="wrapper">
        ...
        <div class="right">
          ...
          <form name="RegForm" onsubmit="return W3docs()" class="register" action="<?php echo URLROOT; ?>/Users/login" method="POST">
        ...
        <button type="submit" class="btn btn-outline-dark rounded"><span style="color: white;">login</span></button>
